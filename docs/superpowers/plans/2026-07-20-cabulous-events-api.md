...
Run: `make manage cmd='test media.tests.test_models.PhotoModelTests.test_photo_stores_global_metadata -v 2'`  
...
Run: `make manage cmd='test media.tests.test_models -v 2'`  
Expected: PASS.
...
Run: `make manage cmd='test events.tests.test_models -v 2'`  
...
Run: `make manage cmd='makemigrations --check --dry-run'`  
...
Run: `make manage cmd='test events.tests.test_lifecycle.CalculateEventStatusTests -v 2'`  
...
Run: `make manage cmd='test events.tests.test_lifecycle -v 2'`  
...
Run: `make manage cmd='test media.tests.test_uploads -v 2'`  
...
Run: `make manage cmd='test media.tests -v 2'`  
Expected: PASS.
...
Run: `make manage cmd='test events.tests.test_api -v 2'`  
...
Run: `make manage cmd='test events.tests.test_relations.ParticipantApiTests -v 2'`  
...
Run: `make manage cmd='test events.tests.test_relations.EventPhotoApiTests -v 2'`  
...
Run: `make manage cmd='test events.tests.test_relations -v 2'`  
Expected: PASS.
...
Run: `make manage cmd='test events.tests.test_highlights -v 2'`  
...
Run: `make manage cmd='test comments.tests.test_models -v 2'`  
...
Run: `make manage cmd='test comments.tests.test_api -v 2'`  
...
Run: `make manage cmd='test events.tests.test_admin media.tests.test_admin comments.tests.test_admin -v 2'`  
...
Run: `make manage cmd='test media events comments -v 2'`  
Expected: PASS.
...
Run: `make check`  
Expected: Ruff check, Ruff format check and mypy all PASS with no new ignores.
