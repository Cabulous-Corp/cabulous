...
class EventAdminRegistrationTests(TestCase):
    ...
    def test_event_changelist_query_count_bounded(self):
    ...
    def test_restore_action_restores_deleted_event(self):
